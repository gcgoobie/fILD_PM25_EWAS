---
title: "CARE Cohort DMP and DMR Analysis - Cell Deconvolution Ax (Not Batch Corrected), Continuous PM2.5"
...
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousPM5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.18 for this analysis.
...
summary(decideTests(fit2))
```
So we can see here that there are 3 CpGs with lower DNAm levels and 2 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousPM5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 1 CpGs with lower DNAm levels and 1 CpGs with higher DNAm levels
...
head(DMPs)
```
TLN2 is a gene with the top CpG that is a cytoskeletan protein involved in actin filament formation and migration of cells, particularly fibroblasts. (https://www.genecards.org/cgi-bin/carddisp.pl?gene=TLN2&keywords=TLN2) 
TLN2 ko mice are resistant to bleo-induced lung fibrosis as per this preprint (https://www.biorxiv.org/content/10.1101/2021.06.07.447403v3)
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousPM5yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gg.manhattan = function(dataframe, title=NULL, cols = c('red', 'skyblue'),
                        ...
                        chrs = 1:22, ymax = NULL,
                        suggestiveline=0, genomewideline=-log10(1.5e-07),
...
```
No overlapping genes on this DMR, but it is on the same chronosome as TLN2 (albeit in a different region of the chromosome)
...
# Write to CSV
write.table(results.ranges_PM5yr_adj, file="CARE_ContinuousPM5yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousSO45yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSO45yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSO45yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_SO45yr_adj, file="CARE_ContinuousSO45yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousNO35yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.29 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNO35yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNO35yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_NO35yr_adj, file="CARE_ContinuousNO35yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousNH45yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNH45yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNH45yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_NH45yr_adj, file="CARE_ContinuousNH45yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousBC5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.41 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousBC5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.20 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousBC5yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_BC5yr_adj, file="CARE_ContinuousBC5yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousOM5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.51 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousOM5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.28 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousOM5yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_OM5yr_adj, file="CARE_ContinuousOM5yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 4 CpGs with lower DNAm levels and 0 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousSS5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSS5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSS5yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
write.table(results.ranges_SS5yr_adj, file="CARE_ContinuousSS5yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousSoil5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSoil5yrPreSamp_DMPs_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.16 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSoil5yrPreSamp_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.10 for this analysis.
...
#write.table(results.ranges_Soil5yr_adj, file="CARE_ContinuousSoil5yrSamp_DMRs_CellDeconvAx_2024_07_18.csv", sep=",", row.names=FALSE)
```
