---
title: "Simmons Cohort DMP and DMR Analysis - ComBat + Cell Deconvolution Ax, Continuous PM2.5"
...
Below is loading the ComBat corrected bVals and mVals objects (steps to get to this are shown below, where they were originally created using this file)
```{r}
...
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousPM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 0 CpGs with lower DNAm levels in low vs high PM2.5 in 5yrs pre-sampling and 0 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousPM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
head(DMPs)
```
CRTAP is top CpG, but p=0.13 after FDR-correction
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousPM5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_PM5yr_adj, file="Simmons_ContinuousPM5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 1661 CpGs with lower DNAm levels and 5126 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousSO45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.73 for this analysis.
...
summary(decideTests(fit2))
```
So we can see here that there are 1 CpGs with lower DNAm levels in low vs high SO4 in 5yrs pre-sampling and 3 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousSO45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.33 for this analysis.
...
summary(decideTests(fit2))
```
So we can see here that there are 2 CpGs with lower DNAm levels and 3 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousSO45yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gg.manhattan = function(dataframe, title=NULL, cols = c('red', 'skyblue'),
                        chr.fld = 'CHR', pos.fld = 'BP', p.fld = 'P', snp.fld = 'rsid', gene.fld=NULL,
                        chrs = 1:22, ymax = NULL,
                        suggestiveline=0, genomewideline=-log10(8e-07),
                        annotate=F, annotate.fld=NULL, SNPlist=NULL,lab2lim=NULL,lab3lim=NULL) {
  library(data.table)
  library(ggplot2)
  library(dplyr)
...
```
Sig DMR in RNF5 (https://www.genecards.org/cgi-bin/carddisp.pl?gene=RNF5 - RNF5 is ring finger protein 5, which is a membrane-bound ubiquitin ligase that is implicated in CF and IBD)
...
write.table(results.ranges_SO45yr_adj, file="Simmons_ContinuousSO45yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousNO35yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousNO35yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousNO35yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 0.94 for this analysis.
...
#write.table(results.ranges_NO35yr_adj, file="Simmons_ContinuousNO35yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 559 CpGs with lower DNAm levels and 1934 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousNH45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 1 CpGs with lower DNAm levels and 2 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousNH45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 3 CpGs with lower DNAm levels and 3 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousNH45yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.40 for this analysis.
...
gg.manhattan = function(dataframe, title=NULL, cols = c('red', 'skyblue'),
                        chr.fld = 'CHR', pos.fld = 'BP', p.fld = 'P', snp.fld = 'rsid', gene.fld=NULL,
                        chrs = 1:22, ymax = NULL,
                        suggestiveline=0, genomewideline=-log10(7e-07),
                        annotate=F, annotate.fld=NULL, SNPlist=NULL,lab2lim=NULL,lab3lim=NULL) {
  library(data.table)
  library(ggplot2)
  library(dplyr)
...
```
Sig DMR in VTRNA2-1 (https://www.genecards.org/cgi-bin/carddisp.pl?gene=VTRNA2-1&keywords=VTRNA2-1 - gene produces an RNA pol III transcript that directly inhibits protein kinase R, which regulates cell growth)
...
write.table(results.ranges_NH45yr_adj, file="Simmons_ContinuousNH45yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousBC5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousBC5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousBC5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_BC5yr_adj, file="Simmons_ContinuousBC5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousOM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousOM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousOM5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.07 for this analysis.
...
#write.table(results.ranges_OM5yr_adj, file="Simmons_ContinuousOM5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousSS5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 0.78 for this analysis.
...
summary(decideTests(fit2))
```
So we can see here that there are 0 CpGs with lower DNAm levels in low vs high SS in 5yrs pre-sampling and 0 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousSS5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousSS5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 0.79 for this analysis.
...
### Gene Ontology Adjusted Analysis
```{r}
#enrichment_GO_SS5yr_adj <- goregion(results.ranges_SS5yr_adj[1:6], all.cpg = rownames(mVals), collection = "GO", array.type = "EPIC")
...
#write.table(results.ranges_SS5yr_adj, file="Simmons_ContinuousSS5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_ContinuousSoil5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousSoil5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_ContinuousSoil5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_Soil5yr_adj, file="Simmons_ContinuousSoil5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
