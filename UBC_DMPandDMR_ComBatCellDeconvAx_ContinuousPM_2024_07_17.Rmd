---
title: "CARE Cohort DMP and DMR Analysis - ComBat + Cell Deconvolution Ax, Continuous PM2.5"
...
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousPM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousPM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousPM5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
# Write to CSV
write.table(results.ranges_PM5yr_adj, file="CARE_ContinuousPM5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousSO45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSO45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSO45yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_SO45yr_adj, file="CARE_ContinuousSO45yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousNO35yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.24 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNO35yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNO35yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_NO35yr_adj, file="CARE_ContinuousNO35yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousNH45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNH45yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousNH45yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_NH45yr_adj, file="CARE_ContinuousNH45yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousBC5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousBC5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousBC5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_BC5yr_adj, file="CARE_ContinuousBC5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousOM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousOM5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousOM5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_OM5yr_adj, file="CARE_ContinuousOM5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousSS5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSS5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 0.73 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSS5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_SS5yr_adj, file="CARE_ContinuousSS5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREUnadjusted_ContinuousSoil5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSoil5yrPreSamp_DMPs_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="CAREAdjusted_ContinuousSoil5yrPreSamp_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_Soil5yr_adj, file="CARE_ContinuousSoil5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_02.csv", sep=",", row.names=FALSE)
```
