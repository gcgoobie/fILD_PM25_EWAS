---
title: "Simmons IPF Only Cohort DMP and DMR Analysis - ComBat + Cell Deconvolution Ax, Continuous PM2.5"
...
```
Takes us down to 172 observations.
...
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousPM5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousPM5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
head(DMPs)
```
CRTAP is second CpG, but p=0.54 after FDR-correction
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousPM5yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_PM5yr_adj, file="Simmons_IPF_ContinuousPM5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousSO45yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
summary(decideTests(fit2))
```
So we can see here that there are 1 CpGs with lower DNAm levels in low vs high SO4 in 5yrs pre-sampling and 0 CpGs with higher DNAm levels
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousSO45yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousSO45yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
write.table(results.ranges_SO45yr_adj, file="Simmons_IPF_ContinuousSO45yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousNO35yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousNO35yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousNO35yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_NO35yr_adj, file="Simmons_IPF_ContinuousNO35yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousNH45yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousNH45yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.15 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousNH45yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 1.34 for this analysis.
...
write.table(results.ranges_NH45yr_adj, file="Simmons_IPF_ContinuousNH45yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousBC5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousBC5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousBC5yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_BC5yr_adj, file="Simmons_IPF_ContinuousBC5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousOM5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousOM5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousOM5yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_OM5yr_adj, file="Simmons_IPF_ContinuousOM5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousSS5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 0.72 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousSS5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
gif
```
The genomic inflation factor (lambda) is 0.76 for this analysis.
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousSS5yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_SS5yr_adj, file="Simmons_IPF_ContinuousSS5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsUnadjusted_IPF_ContinuousSoil5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousSoil5yrPreSamp_DMPs_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
Write the DMPs df to a table
```{r, eval=F}
write.table(DMPs, file="SimmonsAdjusted_IPF_ContinuousSoil5yrPreSamp_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
...
#write.table(results.ranges_Soil5yr_adj, file="Simmons_IPF_ContinuousSoil5yrSamp_DMRs_ComBatCellDeconvAx_2024_07_22.csv", sep=",", row.names=FALSE)
```
